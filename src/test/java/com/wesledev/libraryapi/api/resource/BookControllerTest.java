...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception {
        ...
        Book savedBook = Book.builder().id(10l).author("Teste").title("teste").isbn("001").build();
    ...
    @Test
    @DisplayName("Deve retornar resource not fount quando o livro nao procurado nao existir")
    void bookNotFountTest() throws Exception {
    ...
    void updateBookTest() throws Exception {
        ...
        Book updatingBook = Book.builder().id(1l).title("soma title").author("some author").isbn("321").build();
        BDDMockito.given(service.getById(id)).willReturn(Optional.of(updatingBook));

        Book updatedBook = Book.builder().id(id).author("Teste").title("teste").isbn("321").build();
